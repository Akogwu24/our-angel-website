...
export const RecentLaunchCard = () => {
  return (
    <Stack w='full' bg='white' shadow='md' borderRadius={5}>
      <Image width={200} height={100} className='h-[250px] rounded w-full object-cover' src='/images/home/car.svg' alt='opportunity' />
