  ...
  return (
    <PageWrapper>
      <Stack as='section'>
        ...
        <Text textStyle={'h2'} fontSize={'2.5rem'} align='center' mt={16}>
          Why Choose Ourangels for Fund Management?
        </Text>
        <Text align='center' maxW='900px' mx='auto' mb={5}>
          Our platform offers an unparalleled suite of tools designed to streamline the fundraising process, empower your investments in high-potential startups, and
          manage your relationships with limited partners—all in one place.
        </Text>
